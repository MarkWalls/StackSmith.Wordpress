...
##   $ docker build -t php-for-markwalls-stacksmith-wordpress .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-markwalls-stacksmith-wordpress
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="lsttomx" \
    STACKSMITH_STACK_NAME="PHP for MarkWalls/StackSmith.Wordpress" \
